...
![查询目的主机内网 IP 地址](查询内网%20IP%20地址.png)
...
![绑定目的主机 MAC 地址和内网 IP 地址](绑定%20IP%20与%20MAC%20地址.png)

记得要在目的主机连接的网络的网络设置中关闭随机硬件地址选项！

![关闭随机硬件地址](关闭随机硬件地址.png)
